                ...
                {activeDropdown === 'subCategory' && (
                  ...
                  >
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 text-sm font-medium transition-all duration-150 first:rounded-t-lg border-b border-darkPurple-900/40 ${!activeFilters.subCategory
                        ? 'bg-darkPurple-900/70 text-yellowGradient-start'
                        : 'text-darkPurple-100 hover:bg-darkPurple-900/80 hover:text-yellowGradient-start'
                        }`}
                    >
                    ...
                    {getSubCategoriesByBrand(activeFilters.brand).map(series => (
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 text-sm font-medium transition-all duration-150 last:rounded-b-lg border-b border-darkPurple-900/40 last:border-b-0 active:bg-darkPurple-800 ${activeFilters.subCategory === series
                          ? 'bg-darkPurple-900/70 text-yellowGradient-start'
                          : 'text-darkPurple-100 hover:bg-darkPurple-900/80 hover:text-yellowGradient-start'
                          }`}
                      >
